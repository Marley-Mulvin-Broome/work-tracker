...
Whenever you are considering implementing a component or functionality, search for whether there is an existing component in the project that you can reuse. If there is, use it. If there isn't, create a new component in the appropriate place in the project structure.
